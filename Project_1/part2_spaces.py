...
'''
 START OF 'MAIN'
'''
print 'Would you like to specify input file name? If no default sample2.txt will be loaded (y or n)'
Qresponse = input()
print str(Qresponse)

print TESST
if(str(Qresponse) == "y" or Qresponse == 'Y'):
    inputLoc = input('Input file name:')
print 'Would you like to run the Hill Climbing Algorithm, Genetic or Both? \n'
Qresponse = input('Enter algorithm Type:  ''h'' for hill climbing ''g'' foe genetic ''b'' for Both \n:')
if(Qresponse == 'b' or Qresponse == 'B'):
    algRun = input('Both')
elif(Qresponse == 'h' or Qresponse == 'H'):
    algRun = input('HillClimb')
elif(Qresponse == 'g' or Qresponse == 'G'):
    algRun = input('Genetic')
